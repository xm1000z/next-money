...
export default function SignInForm() {
  ...
  appearance={{
    elements: {
      ...
      formFieldInput: 'flex h-9 w-full border bg-transparent px-3 py-1 text-sm text-black dark:text-white transition-colors file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 shadow-none',
