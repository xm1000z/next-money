    ...
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-[100px] md:mt-[160px]">
        ...
        <div className="text-center flex flex-col space-y-4">
          <span className="font-medium font-mono text-center text-[50px] md:text-[80px] lg:text-[90px] xl:text-[100px] leading-none text-black dark:text-white [-webkit-text-stroke:2px_#000] dark:[-webkit-text-stroke:2px_#fff]">
