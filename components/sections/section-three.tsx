      ...
      <div className="border border-border mx-4 md:container md:px-0 bg-white dark:bg-[#121212] p-8 md:p-10 md:pb-0 overflow-hidden">
        <div className="flex flex-col md:space-x-12 md:flex-row">
          <div className="mt-6 md:max-w-[40%] md:mr-8 md:mb-8">
            <h3 className="font-medium text-xl md:text-2xl mb-4 text-gray-900 dark:text-white">
            ...
            <div className="flex space-x-2 items-center mt-8 text-sm">
              ...
              <span className="text-gray-600 dark:text-[#878787]">Live time tracking</span>
            </div>
            <div className="flex space-x-2 items-center mt-1 text-sm">
              ...
              <span className="text-gray-600 dark:text-[#878787]">Share with your clients</span>
            </div>
          </div>
