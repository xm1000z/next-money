...
export function HeroImage() {
  ...
  return (
    <div className="no-container pl-[50px] scale-100 sm:scale-100 md:scale-[0.4] lg:scale-[0.25] xl:scale-100 mt-10 md:mt-0 lg:absolute -right-[150px] -top-[50px] 2xl:scale-[1] 2xl:-top-[20px]">
      <motion.div
